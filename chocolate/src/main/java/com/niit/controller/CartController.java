...
public class CartController {
	...
	public ModelAndView updateCartItem(@PathVariable("citemid")int citemid,@RequestParam("quantity")int quantity,HttpSession session,Model m)
	{
	...
	@RequestMapping("/chocolate/receipt?")
	public void statuscart()
	{
		cartDAO.cartstatus();
